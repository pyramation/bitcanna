...
export const QueryGetBitcannaidRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetBitcannaidRequest>, I>>(object: I): QueryGetBitcannaidRequest {
    const message = createBaseQueryGetBitcannaidRequest();
...
export const QueryGetBitcannaidResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetBitcannaidResponse>, I>>(object: I): QueryGetBitcannaidResponse {
    const message = createBaseQueryGetBitcannaidResponse();
...
export const QueryAllBitcannaidRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllBitcannaidRequest>, I>>(object: I): QueryAllBitcannaidRequest {
    const message = createBaseQueryAllBitcannaidRequest();
...
export const QueryAllBitcannaidResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllBitcannaidResponse>, I>>(object: I): QueryAllBitcannaidResponse {
    const message = createBaseQueryAllBitcannaidResponse();
...
export const QueryGetSupplychainRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetSupplychainRequest>, I>>(object: I): QueryGetSupplychainRequest {
    const message = createBaseQueryGetSupplychainRequest();
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    return message;
  }
...
export const QueryGetSupplychainResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetSupplychainResponse>, I>>(object: I): QueryGetSupplychainResponse {
    const message = createBaseQueryGetSupplychainResponse();
...
export const QueryAllSupplychainRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllSupplychainRequest>, I>>(object: I): QueryAllSupplychainRequest {
    const message = createBaseQueryAllSupplychainRequest();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageRequest.fromPartial(object.pagination) : undefined;
    return message;
  }
...
export const QueryAllSupplychainResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllSupplychainResponse>, I>>(object: I): QueryAllSupplychainResponse {
    const message = createBaseQueryAllSupplychainResponse();
