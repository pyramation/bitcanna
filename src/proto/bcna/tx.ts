...
export const MsgCreateBitcannaid = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateBitcannaid>, I>>(object: I): MsgCreateBitcannaid {
    const message = createBaseMsgCreateBitcannaid();
...
export const MsgCreateBitcannaidResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateBitcannaidResponse>, I>>(object: I): MsgCreateBitcannaidResponse {
    const message = createBaseMsgCreateBitcannaidResponse();
...
export const MsgUpdateBitcannaid = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateBitcannaid>, I>>(object: I): MsgUpdateBitcannaid {
    const message = createBaseMsgUpdateBitcannaid();
    message.creator = object.creator ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    message.bcnaid = object.bcnaid ?? "";
...
export const MsgUpdateBitcannaidResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateBitcannaidResponse>, I>>(_: I): MsgUpdateBitcannaidResponse {
    const message = createBaseMsgUpdateBitcannaidResponse();
    return message;
  }
...
export const MsgDeleteBitcannaid = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteBitcannaid>, I>>(object: I): MsgDeleteBitcannaid {
    const message = createBaseMsgDeleteBitcannaid();
    message.creator = object.creator ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    return message;
...
export const MsgDeleteBitcannaidResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteBitcannaidResponse>, I>>(_: I): MsgDeleteBitcannaidResponse {
    const message = createBaseMsgDeleteBitcannaidResponse();
    return message;
  }
...
export const MsgCreateSupplychain = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateSupplychain>, I>>(object: I): MsgCreateSupplychain {
    const message = createBaseMsgCreateSupplychain();
    message.creator = object.creator ?? "";
...
export const MsgCreateSupplychainResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateSupplychainResponse>, I>>(object: I): MsgCreateSupplychainResponse {
    const message = createBaseMsgCreateSupplychainResponse();
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    return message;
  }
...
export const MsgUpdateSupplychain = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateSupplychain>, I>>(object: I): MsgUpdateSupplychain {
    const message = createBaseMsgUpdateSupplychain();
    message.creator = object.creator ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    message.product = object.product ?? "";
...
export const MsgUpdateSupplychainResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateSupplychainResponse>, I>>(_: I): MsgUpdateSupplychainResponse {
    const message = createBaseMsgUpdateSupplychainResponse();
    return message;
  }
...
export const MsgDeleteSupplychain = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteSupplychain>, I>>(object: I): MsgDeleteSupplychain {
    const message = createBaseMsgDeleteSupplychain();
    message.creator = object.creator ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    return message;
...
export const MsgDeleteSupplychainResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteSupplychainResponse>, I>>(_: I): MsgDeleteSupplychainResponse {
    const message = createBaseMsgDeleteSupplychainResponse();
    return message;
  }
