...
export const MessageComposer = {
  encoded: {
    createBitcannaid(value: MsgCreateBitcannaid) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgCreateBitcannaid",
    ...
    updateBitcannaid(value: MsgUpdateBitcannaid) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgUpdateBitcannaid",
    ...
    deleteBitcannaid(value: MsgDeleteBitcannaid) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgDeleteBitcannaid",
    ...
    createSupplychain(value: MsgCreateSupplychain) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgCreateSupplychain",
    ...
    updateSupplychain(value: MsgUpdateSupplychain) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgUpdateSupplychain",
    ...
    deleteSupplychain(value: MsgDeleteSupplychain) {
      return {
        type_url: "/BitCannaGlobal.bcna.bcna.MsgDeleteSupplychain",
